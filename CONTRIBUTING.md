...
- Run the Vitest 5 suite on Node 22.22.3+, Node 24.15+, or Node 26+. Node 25 remains supported for the OpenClaw runtime, but is outside Vitest 5's declared engine range.
